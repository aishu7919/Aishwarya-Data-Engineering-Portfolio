...
PROJECT_ID = 'clouddataengg'
REGION = 'us-east1'
CLUSTER_CONFIG = {
    "gce_cluster_config": {
    "zone_uri": "us-east1-b",
    "service_account": "airflow-dataproc-sa@clouddataengg.iam.gserviceaccount.com"
    
    },
    'master_config': {
        'num_instances': 1, # Master node
        "machine_type_uri": "e2-standard-2",  # Machine type
        'disk_config': {
...
PYSPARK_JOB = {
    ...
    "pyspark_job": {
        "main_python_file_uri": "gs://aishwarya-dataproc-exercise1-7919/airflow_project_1/spark_job/emp_batch_job.py"
        },
}
