...
def process_data():
    ...
    bucket = "aishwarya-dataproc-exercise1-7919"
    emp_data_path = f"gs://aishwarya-dataproc-exercise1-7919/airflow_project_1/data/employee.csv"
    dept_data_path = f"gs://aishwarya-dataproc-exercise1-7919/airflow_project_1/data/department.csv"
    output_path = f"gs://aishwarya-dataproc-exercise1-7919/airflow_project_1/output"
