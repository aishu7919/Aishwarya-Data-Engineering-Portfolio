...
def data_processing(date):
    ...
    input_path = f"gs://aishwarya-dataproc-exercise1-7919/airflow_project_2/data/orders_{date}.csv"
    ...
    output_path = f"gs://aishwarya-dataproc-exercise1-7919/airflow_project_2/output/processed_orders_{date}"
