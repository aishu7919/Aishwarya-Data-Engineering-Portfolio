...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow_projects_gds_dev")
    bq_project = Variable.get("bq_project", default_var="project-3b7119ba-2cc0-49b9-95a")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "292902896919-compute@developer.gserviceaccount.com",
